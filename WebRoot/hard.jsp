			  ...
			  <div class="col-md-2">
				<div class="list-group">
					...
					<div class="thumbnail">
					    ...
					    <a id="hard" href="hard.jsp" class="list-group-item active" style="text-align: center;">困难：算术天才</a>
					</div>
				</div>
			  </div>
			  <div class="col-md-10">
			    <div class="alert alert-dismissible alert-info">
				    <button type="button" class="close" data-dismiss="alert">&times;</button>
					 你真棒！<a href="#" class="alert-link">万世想</a>同学，再一次见到你很开心！完成20000道运算后去拼搏奥林匹克竞赛吧！
				</div>
