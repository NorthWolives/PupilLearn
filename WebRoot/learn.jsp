			  ...
			  <div class="col-md-2">
			      <div class="list-group">
				      <div class="thumbnail" style="">
				          ...
				          <a href="learn.jsp" class="list-group-item active" style="text-align: center;">简单：算术小童</a>
				      </div>
				      <div class="thumbnail">
				          <img src="img/pupil2.jpg" alt="...">
				          <a href="" class="list-group-item" style="text-align: center;">较难：算术神童</a>
				      </div>
				      <div class="thumbnail">
				          <img src="img/pupil3.jpg" alt="...">
				          <a href="#" class="list-group-item" style="text-align: center;">困难：算术天才</a>
				      </div>
			      </div>
			  </div>
			  <div class="col-md-10">
			    ...
			    <div class="page-header">
				  <h1>算术天才训练营 <small>简单模式</small></h1>
				</div>
				...
				<div class="panel panel-default subject">
				  <div class="panel-body subject" style="text-align: center;">
				    ...
				    <c:if test="${not empty requestScope.formular}">
				        ...
				        <h1 id="result" style="display:none;">正确结果：$$ ${requestScope.result} $$</h1>
					</c:if>
				  </div>
				</div>
				<ul class="pager" style="font-size: 18px;">
				  <li class="previous"><a id="generate_easy" href="generate_easy.do">再来一题 &rarr;</a></li>
